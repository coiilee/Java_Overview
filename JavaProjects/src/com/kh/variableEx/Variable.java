...
public class Variable {
    ...
    //변수 선언 : 메모리에 공간 생성
    boolean isTrue; //컴퓨터 메모리에 boolean 저장공간 1byte 를 생성하고
                    //아직 그 공간에는 아무것도 없는 상태이지만
                    //그 공간의 이름은 isTrue 라고 부르겠다.
    //값 대입 : 변수에 값을 집어넣는 것 (이미 값이 존재하는 변수에 대입하면 --> 덮어쓰기가됨)
    //isTrue = true;
