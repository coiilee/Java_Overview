...
//자식클래스가 부모클래스를 상속받아 자식이 자신의 것처럼 사용하는 것
//상속 키워드 extends
public class 자식 extends 부모 {
    ...
    public 자식() {
       //super() : super생성자 부모생성자
        ...
        //super() 생성자를 작성할 경우 항상 자식 생성자 안에서 맨 첫줄에 작성 !!!!!
        super();
         }


    public 자식(String 성씨, int money, String car, String computer) {
        super(성씨, money, car); //부모의 성씨와 돈, 차를 먼저 가져와
        this.computer = computer; //자식이 필드에 작성
    }

    @Override
    public String toString() {
        //super.toString() 부모 클래스에 작성된 toString 불러와서 사용
        return "자식은" + "computer='" + computer;
    }
}
