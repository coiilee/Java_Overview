...
public class ConditionIfEx {
    ...
    * 
    * if(조건1) 조건1이 true일 때 수행할 문장 
    * else-of(조건2) 조건1이 false이고 조건1가 true일 때 수행 
    * 
    * */
    public void method0(){
        ...
        String result ; // 추후 조건에 따른 결과를 담을 공간 생성 
        
        if(age>=19) result = "성인"; 
        else if (age>= 14 && age<=18) result = "청소년";
        else                          result = "어린이";
    ...
    *
    * */
    public void method1(int age){ // 매개변수명 age에 전달인자로 나이가 들어왔을 경우 .
        if(age >= 19){
     ...
     * }
     * */
    public void method2(int age){ //매개변수명 age에 전달인자 값으로 나이가 들어오면
        if(age >= 19){
            System.out.println("성인입니다.");
        } else {
